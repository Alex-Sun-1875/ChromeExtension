...
// @author        thedude
// @homepage      https://userstyles.org/styles/98305
// @run-at        document-start
// @version       0.20151121213329
// ==/UserScript==
(function() {var css = "";
if (false || (document.location.href.indexOf("http://") == 0) || (document.location.href.indexOf("https://") == 0) || (document.location.href.indexOf("ftp://") == 0) || (document.location.href.indexOf("file://") == 0) || (location.href.replace(location.hash,'') == "about:blank") || (new RegExp("^about:(?!addons|app-manager|config|customizing|stylish-edit|downloads|permissions|preferences|sync-tabs|webrtc).*$")).test(document.location.href))
	css += [
		"/*",
