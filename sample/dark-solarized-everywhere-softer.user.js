...
// @homepage      https://userstyles.org/styles/139609
// @run-at        document-start
// @version       0.20170302070941
// ==/UserScript==
(function() {var css = "";
if (false || (document.location.href.indexOf("ftp://") == 0) || (document.location.href.indexOf("file://") == 0) || (location.href.replace(location.hash,'') == "about:blank") || (new RegExp("^(https?://(?!github\\.com)).*$")).test(document.location.href) || (new RegExp("^about:(?!addons|app-manager|config|customizing|stylish-edit|downloads|permissions|preferences|sync-tabs|webrtc).*$")).test(document.location.href))
	css += [
		"/*",
